...
export class PrismaCourseCategoryMapper {
    static toDomain(persistenceCourseCategory: PrismaCourseCategory): CourseCategory {
    ...
    static toPrisma(domainCourseCategory: CourseCategory): Prisma.CourseCategoryUncheckedCreateInput{
        return {
